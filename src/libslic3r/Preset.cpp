...
static std::vector<std::string> s_Preset_print_options{
    ...
    "custom_infill_mode",
    "custom_infill_pattern_id",
    "custom_infill_tile_width",
    "custom_infill_tile_height",
    ...
    "continuous_toolpath",
    "continuous_toolpath_single",
    "continuous_toolpath_sacrificial_max",
...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "robot_reach_min", "robot_reach_max", "robot_sweep_angle", "robot_base_offset", "robot_base_rotation",
